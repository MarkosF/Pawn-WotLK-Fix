...
function PawnUIFrame_UpgradeTrackingList_UpdateSelection()
	...
	-- Replace SetShown with Show/Hide for 3.3.5 compatibility
	if IsOptionAvailable then
		PawnUIFrame_UpgradeTrackingHeaderLabel:Show()
		PawnUIFrame_UpgradeTrackingOffRadio:Show()
		PawnUIFrame_UpgradeTrackingOnRadio:Show()
	else
		PawnUIFrame_UpgradeTrackingHeaderLabel:Hide()
		PawnUIFrame_UpgradeTrackingOffRadio:Hide()
		PawnUIFrame_UpgradeTrackingOnRadio:Hide()
	end
end
